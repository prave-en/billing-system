...
header("location: new_entry1.php"); // Redirecting To Profile Page
}
?>
...
$query = "SELECT username, password from entry_login where username=? AND password=? LIMIT 1";
...
$_SESSION['entry_login_session'] = $username; // Initializing Session
header("location: new_entry1.php"); // Redirecting To Profile Page
}
...
<tr><td class="container" align="center">
  ...
  <tr>
      ...
      <td align="center">
        <b>Entry Login</b><br><br>
        <form action="entry_login.php" method="post" autocomplete="off">
  <input type="text" name="username" placeholder="Username" required=""><br><br><input type="password" name="password" placeholder="Password" required=""><br><br><input type="submit" name="entry_login" value="LOGIN" class="lnbtn"></form><br><br>
