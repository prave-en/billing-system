...
header("location: admin_home.php"); // Redirecting To Profile Page
}
?>

<?php
session_start(['admin_login_session']); // Starting Session
...
$query = "SELECT username, password from admin_login where username=? AND password=? LIMIT 1";
...
$_SESSION['admin_login_session'] = $username; // Initializing Session
header("location: admin_home.php"); // Redirecting To Profile Page
}
...
<tr><td class="container" align="center">
  ...
  <input type="text" name="username" placeholder="Username" required=""><br><br><input type="password" name="password" placeholder="Password" required=""><br><br><input type="submit" name="admin_login" value="LOGIN" class="lnbtn"></form><br><br>
